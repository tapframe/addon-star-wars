...
const outputFilePath = path.join(__dirname, '../Data/moviesSeriesChronologicalData.js');

// --- List of Content to Fetch (Chronological Order) ---
const contentList = [
...
// --- Main Fetch Function ---
async function fetchChronologicalData() {
    console.log('🚀 Starting Movies & Series Chronological data fetching process...');
    const finalData = [];
    ...
    console.log('\n✨ Movies & Series Chronological data fetching complete.');
}
